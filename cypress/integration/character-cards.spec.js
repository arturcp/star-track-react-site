  ...
  context('Card content', () => {
    ...
    it('builds Carmen card', () => {
      ...
      cy.get('@cards')
        ...
        .should(
          'have.text',
          'Curiosa, leonina (isso já diz tudo) e não gosta de chá de camomila. Seu sonho é se tornar uma espiã mundialmente famosa.',
        );
    });
    ...
    it('builds Sam card', () => {
      ...
      cy.get('@cards')
        ...
        .should(
          'have.text',
          'Et, telefone, minha casa, mas não necessariamente nessa mesma ordem.',
        );
    });
